...
// 47--- Дан масив [1, 2, 3, 4, 5]. За допомогою методу/функції splice зробіть
// з нього масив [1, 'a', 'b', 2, 3, 4, 'c', 5, 'e'].
// let arr= [1, 2, 3, 4, 5];
// arr.splice(1, 0, 'a', 'b');
// arr.splice(6, 0, 'c');
// arr.splice(8, 0, 'e');
...
//75 3. используя Math.random заполнить массив из ???(сколько хотите) элементов.
...
//86 3 створити масив з рандомними значеннями, помножити 
//всі його елементи на 5 та перемістити їх в інший масив.
// let arr1 = [];
// let arr2 = [];
// for (let i = 0; i< 50; i++) {
